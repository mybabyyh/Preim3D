...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--encoder_number_layers', default=50, type=int, help='Number of Encoder\'s layers')
        ...
        self.parser.add_argument('--eg3d_generator', default=model_paths['eg3d_ffhq'], type=str,
                                 help='Path to EG3D generator')
        ...
        # preim3d
        self.parser.add_argument('--outer_times', default=1, type=int,
                                 help='number of outer image in a train loop block')
        self.parser.add_argument('--inner_times', default=0, type=int,
                                 help='number of inner image in a train loop block')
        self.parser.add_argument('--w_rec_lambda_start', type=float, default=0, help="lambda for w reconstruction loss")
        self.parser.add_argument('--w_rec_lambda_delta', type=float, default=0, help="lambda delta for w reconstruction loss")
        self.parser.add_argument('--multi_view_start_step', type=int, default=100000, help="multiview id reg start step")
        self.parser.add_argument('--view_count', type=int, default=0, help="Number of view")
        self.parser.add_argument('--multiview_yaws', nargs='+', type=float, default=[-0.25, -0.15, 0.15, 0.25], help="Yaws of multi view")
        self.parser.add_argument('--multiview_pitches', nargs='+', type=float, default=[-0.1, 0.1], help="Pitches of multi view")
        self.parser.add_argument('--id_lambda_multi_view', type=float, default=0, help="Multi view ID loss multiplier factor")
        self.parser.add_argument('--w_rec_interval', type=float, default=0, help="the interval to increase lambda for w reconstruction loss")
